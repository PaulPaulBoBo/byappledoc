...
@property (nonatomic, assign) NSUInteger tokenIndex;
@property (nonatomic, assign) BOOL isLastCommentMultiline;
@property (nonatomic, assign) BOOL isPreviousCommentMultiline;
@property (nonatomic, strong) NSMutableString *lastCommentBuilder;
@property (nonatomic, strong) NSMutableString *previousCommentBuilder;
@property (nonatomic, strong) PKToken *lastCommentToken;
@property (nonatomic, strong) PKToken *previousCommentToken;
@property (nonatomic, strong) NSString *singleLineCommentAfterRegex;
@property (nonatomic, strong) NSString *singleLineCommentRegex;
@property (nonatomic, strong) NSString *multiLineCommentRegex;
@property (nonatomic, strong) NSString *commentDelimiterRegex;
...
- (NSUInteger)offsetOfLineContainingOffset:(NSUInteger)offset {
    ...
    NSRange newlineRange = [self.input rangeOfCharacterFromSet:[NSCharacterSet newlineCharacterSet]                                  options:NSBackwardsSearch                                    range:NSMakeRange(0, offset)];
...
- (NSInteger)indentationAtOffset:(NSUInteger)offset {
    ...
    NSRange nonWhitespaceRange = [self.input rangeOfCharacterFromSet:nonWhitespace                                        options:0                                          range:lineToOffsetRange];
