...
/** Comments short description used for tooltips and abstract in the form of `GBCommentComponent`.
 ...
 @see longDescription
 */
@property (nonatomic, strong) GBCommentComponent *shortDescription;
 ...
 */
@property (nonatomic, strong) GBCommentComponentsList *longDescription;
 ...
 */
@property (nonatomic, strong) GBCommentComponentsList *relatedItems;
...
/** All registered method parameters, only applicable for methods, empty list is used otherwise.
 ...
 @see methodResult
 */
@property (nonatomic, strong) NSMutableArray *methodParameters;
...
/** All registeres method exceptions, only applicable for methods, empty list if used otherwise.
 ...
 @see methodResult
 */
@property (nonatomic, strong) NSMutableArray *methodExceptions;
...
/** Method result description, only applicable for methods, empty list is used otherwise.
 ...
 @see methodExceptions
 */
@property (nonatomic, strong) GBCommentComponentsList *methodResult;

/** Entity availability description.

 */
@property (nonatomic, strong) GBCommentComponentsList *availability;
...
@property (nonatomic, strong) GBSourceInfo *sourceInfo;
