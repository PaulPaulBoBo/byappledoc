 ...
 */
@property (nonatomic, copy) NSString *nameOfDocument;
@property (nonatomic, copy) NSString *prettyNameOfDocument;
 ...
 */
@property (nonatomic, copy) NSString *pathOfDocument;
...
/** Input base path from the setting at which the document was found.
 ...
 @see nameOfDocument
 */
@property (nonatomic, copy) NSString *basePathOfDocument;
 ...
 */
@property (nonatomic, assign) BOOL isCustomDocument;
