...
@synthesize unDocClasses = _unDocClasses;
@synthesize categories = _categories;
@synthesize unDocCategories = _unDocCategories;
@synthesize protocols = _protocols;
@synthesize unDocProtocols = _unDocProtocols;
@synthesize constants = _typedefEnums;
@synthesize unDocConstants = _unDocConstants;
@synthesize blocks = _typedefBlocks;
@synthesize unDocBlocks = _unDocBlocks;
@synthesize documents = _documents;
@synthesize customDocuments = _customDocuments;
@synthesize methods = _methods;
@synthesize unDocMethods = _unDocMethods;
