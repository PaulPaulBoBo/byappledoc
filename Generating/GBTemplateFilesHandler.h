 ...
 */
@property (nonatomic, strong) NSMutableDictionary *templateFiles;
...
/** Returns user-friendly template path string including `outputSubpath`. 
 ...
 @see outputUserPath
 */
@property (nonatomic, copy) NSString *templateUserPath;
 ...
 */
@property (nonatomic, copy) NSString *outputUserPath;
