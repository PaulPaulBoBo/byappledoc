...
NSError *_BVPOSIXError(NSURL *url) {
    ...
    NSString *errorDescription = [NSString stringWithFormat:@"File %@ could not be opened. %s.", [url path], strerror(errno)];
    NSDictionary *userInfo = @{NSLocalizedDescriptionKey :errorDescription,
            NSUnderlyingErrorKey :underlyingError,
            NSFilePathErrorKey :[url path]};
    NSError *error = [[NSError alloc] initWithDomain:BVPlistExtractorErrorDomain                           code:BVPlistExtractorErrorOpenFile                       userInfo:userInfo];
...
NSError *_BVGenericError(NSURL *url, NSString *fileQualifier, NSInteger errorCode) {
    ...
    NSDictionary *userInfo = @{NSLocalizedDescriptionKey :errorDescription,
            NSFilePathErrorKey :[url path]};
    NSError *error = [[NSError alloc] initWithDomain:BVPlistExtractorErrorDomain                           code:errorCode                       userInfo:userInfo];
