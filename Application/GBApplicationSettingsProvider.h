...
@property (nonatomic, copy) NSString *docsetBundleIdentifier;

/** Documentation set bundle name. */
@property (nonatomic, copy) NSString *docsetBundleName;

/** Documentation set certificate issuer. */
@property (nonatomic, copy) NSString *docsetCertificateIssuer;

/** Documentation set certificate signer. */
@property (nonatomic, copy) NSString *docsetCertificateSigner;

/** Documentation set description. */
@property (nonatomic, copy) NSString *docsetDescription;

/** Documentation set fallback URL. */
@property (nonatomic, copy) NSString *docsetFallbackURL;

/** Documentation set feed name. */
@property (nonatomic, copy) NSString *docsetFeedName;

/** Documentation set feed URL. */
@property (nonatomic, copy) NSString *docsetFeedURL;
...
/** Specifies the format docsets should be published in.
 ...
 @see publishDocSet
 */
@property (nonatomic, assign) GBPublishedFeedFormats docsetFeedFormats;

/** Documentation set package URL. */
@property (nonatomic, copy) NSString *docsetPackageURL;

/** Documentation set minimum Xcode version. */
@property (nonatomic, copy) NSString *docsetMinimumXcodeVersion;

/** Documentation set platform family for using within Dash. */
@property (nonatomic, copy) NSString *dashDocsetPlatformFamily;

/** Documentation set platform family. */
@property (nonatomic, copy) NSString *docsetPlatformFamily;

/** Documentation set publisher identifier. */
@property (nonatomic, copy) NSString *docsetPublisherIdentifier;

/** Documentation set publisher name. */
@property (nonatomic, copy) NSString *docsetPublisherName;

/** Documentation set human readble copyright message. */
@property (nonatomic, copy) NSString *docsetCopyrightMessage;

/** The name of the documentation set installed bundle. The folder is generated in `docsetInstallPath`. */
@property (nonatomic, copy) NSString *docsetBundleFilename;

/** The name of the documentation set atom file when generating publishing files. The file is generated in `outputPath`. */
@property (nonatomic, copy) NSString *docsetAtomFilename;

/** The name of the documentation set xml file when generating publishing files. The file is generated in `outputPath`. */
@property (nonatomic, copy) NSString *docsetXMLFilename;
...
@property (nonatomic, copy) NSString *docsetPackageFilename;
...
@property (nonatomic, copy) NSString *docsetInstallPath;

/** The path to `xcrun` tool, including tool filename. */
@property (nonatomic, copy) NSString *xcrunPath;
 ...
 */
@property (nonatomic, strong) NSMutableSet *includePaths;
...
/** The path to the source file used for injection into autogenerated main index html.
 ...
 @see includePaths
 */
@property (nonatomic, copy) NSString *indexDescriptionPath;
 ...
 */
@property (nonatomic, strong) NSMutableSet *ignoredPaths;
 ...
 */
@property (nonatomic, strong) NSMutableSet *excludeOutputPaths;
...
/** Indicates whether HTML files should be generated or not.
 ...
 @see createDocSet
 */
@property (nonatomic, assign) BOOL createHTML;
 ...
 */
@property (nonatomic, assign) BOOL createMarkdown;
...
/** Specifies whether documentation set should be created from the HTML files.
 ...
 @see publishDocSet
 */
@property (nonatomic, assign) BOOL createDocSet;
...
/** Specifies whether the documentation set should be created at the install path or not.
 ...
 @see installDocSet
 */
@property (nonatomic, assign) BOOL finalizeDocSet;
...
/** Specifies whether the documentation set should be installed or not.
 ...
 @see publishDocSet
 */
@property (nonatomic, assign) BOOL installDocSet;
...
/** Specifies whether the documentation set should be prepared for publishing or not.
 ...
 @see installDocSet
 */
@property (nonatomic, assign) BOOL publishDocSet;
...
/** Specifies the format docsets should use for their html anchors.
 ...
 @see createDocSet
 */
@property (nonatomic, assign) GBHTMLAnchorFormat htmlAnchorFormat;
 ...
 */
@property (nonatomic, assign) BOOL keepIntermediateFiles;
 ...
 */
@property (nonatomic, assign) BOOL cleanupOutputPathBeforeRunning;
 ...
 */
@property (nonatomic, assign) BOOL repeatFirstParagraphForMemberDescription;
 ...
 */
@property (nonatomic, assign) BOOL preprocessHeaderDoc;
 ...
 */
@property (nonatomic, assign) BOOL printInformationBlockTitles;
 ...
 */
@property (nonatomic, assign) BOOL useSingleStarForBold;
 ...
 */
@property (nonatomic, assign) BOOL keepUndocumentedObjects;
 ...
 */
@property (nonatomic, assign) BOOL keepUndocumentedMembers;
...
/** Specifies whether undocumented inherited methods or properties should be searched for in known places.
 ...
 @see keepUndocumentedMembers
 */
@property (nonatomic, assign) BOOL findUndocumentedMembersDocumentation;
 ...
 */
@property (nonatomic, assign) BOOL mergeCategoriesToClasses;
 ...
 */
@property (nonatomic, assign) BOOL mergeCategoryCommentToClass;
...
/** Indicates whether category or extension sections should be preserved when merging into extended class.
 ...
 @see mergeCategoriesToClasses
 */
@property (nonatomic, assign) BOOL keepMergedCategoriesSections;
...
/** Indicates whether merged section names from categories should be prefixed with category name.
 ...
 @see mergeCategoriesToClasses
 */
@property (nonatomic, assign) BOOL prefixMergedCategoriesSectionsWithCategoryName;
 ...
 */
@property (nonatomic, assign) BOOL useCodeOrder;
 ...
 */
@property (nonatomic, assign) BOOL prefixLocalMembersInRelatedItemsList;
 ...
 */
@property (nonatomic, assign) BOOL treatDocSetIndexingErrorsAsFatals;
 ...
 */
@property (nonatomic, assign) int exitCodeThreshold;

/** Title of the documentation section */
@property (nonatomic, copy) NSString *docsSectionTitle;
 ...
 */
@property (nonatomic, assign) BOOL warnOnMissingOutputPathArgument;
 ...
 */
@property (nonatomic, assign) BOOL embedCrossReferencesWhenProcessingMarkdown;
 ...
 */
@property (nonatomic, assign) BOOL embedAppledocBoldMarkersWhenProcessingMarkdown;
...
@property (nonatomic, strong) GBCommentComponentsProvider *commentComponents;

/** Returns the `GBApplicationStringsProvider` object that specifies all string templates used for output generation. */
@property (nonatomic, strong) GBApplicationStringsProvider *stringTemplates;
